...
beautiful.wallpaper         = "/home/roys/Pictures/linux_terminal_wallpaper.png"
...
-- This is used later to determine the default applications
browser = "firefox"
lock_cmd = "xtrlock -b"
...
awful.key({ }, "#238", function() brightness_widget:inc() end)
awful.key({ }, "#237", function() brightness_widget:dec() end)
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "w", function () mymainmenu:show() end,
		...
		awful.key({modkey, "Mod1"     }, "l",      function () awful.spawn(lock_cmd) end,
